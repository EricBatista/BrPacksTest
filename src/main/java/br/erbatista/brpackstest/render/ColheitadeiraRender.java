...
public class ColheitadeiraRender extends GeoEntityRenderer<ColheitadeiraEntity>
{
    public ColheitadeiraRender(EntityRendererManager renderManager)
    {
    ...
    @Override
    public void render(GeoModel model, ColheitadeiraEntity animatable, float partialTicks, RenderType type, MatrixStack matrixStackIn, @Nullable IRenderTypeBuffer renderTypeBuffer, @Nullable IVertexBuilder vertexBuilder, int packedLightIn, int packedOverlayIn, float red, float green, float blue, float alpha) {
